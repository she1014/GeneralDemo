...
import com.techfly.demo.adpter.StringListAdapter;
import com.techfly.demo.selfview.PaddingItemDecoration;

import java.util.ArrayList;

public abstract class BaseActivity2 extends Activity implements SwipeRefreshLayout.OnRefreshListener, OnMoreListener, SwipeDismissRecyclerViewTouchListener.DismissCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecycler = (SuperRecyclerView) findViewById(R.id.super_recyclerview);
