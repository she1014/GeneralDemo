 ...
 * 退款
 */
public class OCFrag extends BaseFragment {
    ...
    private String mStatus = "ACCEPT_WAITTING,PS_WAITTING,RECEIVE_WAITTING,FINISHED&refund_status=REFUNDED,REFUND_DENY";
