...
public class SlideDetailsLayout extends ViewGroup {
    ...
    private String TAG = "SlideDetailsLayout";
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        Log.i(TAG,"onLayout,t="+t+",b="+b+",l="+l+",t="+t+",offset="+offset);
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            Log.i("test","onLayout,left="+left+",top="+top+",right="+right+",bottom="+bottom);
    ...
    private void checkAndFirstOpenPanel() {
        Log.i(TAG,"checkAndFirstOpenPanel");
