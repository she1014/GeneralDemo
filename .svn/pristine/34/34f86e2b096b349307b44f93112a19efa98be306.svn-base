 ...
 * 出售中
 */
public class GMBFrag extends BaseFragment {
    ...
    private String mStatus = "下架";

    private String m_cur_aid = "";
    private int m_default = 0;

    private int type = 2;//仓库中
...
//                    fragmentChangeListener.onCurrentposition(mTotalRecord);
                    fragmentChangeListener.onCurrentposition(2,mTotalRecord);
