 ...
 * 退款详情-商品列表
 */
public class RefundDetailGoodsItemLvAdapter extends BaseAdapter {
    private Context mContext;
    private List<RefundOrderDetailBean.DataEntity.GoodsInfoEntity> listData;
    private LayoutInflater layoutInflater;
    private ItemMultClickListener mItemClickListener;
    private Boolean isShowEvaluate = false;

    public RefundDetailGoodsItemLvAdapter(Context context, List<RefundOrderDetailBean.DataEntity.GoodsInfoEntity> list, Boolean isShow) {
    ...
    public void addAll(List<RefundOrderDetailBean.DataEntity.GoodsInfoEntity> info) {
