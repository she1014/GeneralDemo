 ...
 * TODO<>
 */
public class Demo21RvAdapter extends RecyclerView.Adapter<Demo21RvAdapter.MViewHolder> {
    ...
    public Demo21RvAdapter(Context context, List<DemoBean> shopBeans, int status) {
