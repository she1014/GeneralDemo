package com.techfly.demo.selfview.richeditor;
...
public class RichTextEditor extends ScrollView {
    ...
    private static final int EDIT_FIRST_PADDING_TOP = 3; // 第一个EditText的paddingTop值
    ...
    public RichTextEditor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        EditText firstEdit = createEditText("编辑内容~~",
    ...
    private EditText createEditText(String hint, int paddingTop) {
        EditText editText = (EditText) inflater.inflate(R.layout.layout_rich_edit_item,
                null);
    ...
    private RelativeLayout createImageLayout() {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(
                R.layout.layout_rich_edit_imageview, null);
    ...
    private void insertImage(Bitmap bitmap, String imagePath) {
        ...
        Log.i("TTSS", "前:cursorIndex=" + cursorIndex + ",lastEditIndex=" + lastEditIndex);
        ...
        Log.i("TTSS", "后:hocursorIndex=" + cursorIndex + ",lastEditIndex=" + lastEditIndex);
        hideKeyBoard();
    }
    ...
    private void addEditTextAtIndex(final int index, String editStr) {
        EditText editText2 = createEditText("", getResources()
                .getDimensionPixelSize(R.dimen.marign_mini));
