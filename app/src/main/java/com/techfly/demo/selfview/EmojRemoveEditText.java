...
public class EmojRemoveEditText extends EditText {
    ...
    public EmojRemoveEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initEditText();
    }

    public EmojRemoveEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /*public static boolean containsEmoji(String source) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (!isEmojiCharacter(String.valueOf(codePoint))) { //如果不能匹配,则该字符是Emoji表情
                return true;
            }
        }
        return false;
