 ...
 */
public class FlexibileScrollView extends ScrollView {

    private static final String TAG = "UserDefineScrollView";

    private OnScrollChangedCallback mOnScrollChangedCallback;

    private OnScrollBoundback mOnScrollBoundback;//boundBack
    ...
    private static final int ANIM_TIME = 250;///250

    //弹回的次数
    private static int BOUND_COUNT = 0;
    ...
    public FlexibileScrollView(Context context) {
        super(context);
    }

    public FlexibileScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private Handler mHander = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
//                LogsUtil.normal("handleMessage");
                if (mOnScrollBoundback != null) {
                    mOnScrollBoundback.onBoundback(BOUND_COUNT++);
                }
            }
        }
    };
...
//        LogsUtil.normal("boundBack");

        mHander.sendEmptyMessageDelayed(1, ANIM_TIME);
...
//        return false;///为false时，不能上拉
    ...
    public void setOnScrollBoundback(
            final OnScrollBoundback onScrollBoundback) {
        mOnScrollBoundback = onScrollBoundback;
    }
    ...
    public static interface OnScrollBoundback {
