 ...
 * BaseActivity-添加侧滑效果
 */
public class BaseActivity extends SwipeBackActivity implements GetResultCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadDialog = DialogUtil.loadingDialog(BaseActivity.this);
...
//            right_tv.setText(rTitle);
    ...
    public void setTranslucentStatus(int color) {
        ...
        int getSystemType = StatusBarUtil.StatusBarLightMode(BaseActivity.this);
        StatusBarUtil.StatusBarLightMode(BaseActivity.this, getSystemType);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        LogsUtil.normal("BaseActivity.onBackPressed");
//        overridePendingTransition(R.anim.from_top_to_middle, R.anim.from_middle_to_bottom);
    ...
    private void isNetConnect() {
        if (NetWorkUtil.isNetWorkConnected(BaseActivity.this)) {
            ...
            ToastUtil.DisplayToast(BaseActivity.this, Constant.TOAST_MEG_NETWORK_NULL);
        }
    }
    ...
    public void getHttpsTestApi(String url,int type) {
        isNetConnect();
        AppClient.getHttpsTest(url, type, this);
    }
