...
public class SlideAdapt extends BaseAdapter{
    ...
    private static final int pic[] = {R.drawable.qq_setting_svip,R.drawable.qq_setting_qianbao,
                                      ...
                                      R.drawable.qq_setting_xiangce,R.drawable.qq_setting_wenjian,
                                      R.drawable.qq_setting_shoucang,R.drawable.qq_setting_wenjian,
                                      R.drawable.qq_setting_shoucang,R.drawable.qq_setting_wenjian,
                                      R.drawable.qq_setting_shoucang,R.drawable.qq_setting_wenjian,
                                      R.drawable.qq_setting_xiangce,R.drawable.qq_setting_wenjian,
                                      R.drawable.qq_setting_wenjian,R.drawable.qq_setting_wenjian,
                                      R.drawable.qq_setting_wenjian};
    ...
    private static final String pic_name[] =  {"一些特效","侧滑列表","QQ.DEMO","抽奖装盘","流星雨弹幕",
            ...
            "横向加载更多(可用)","ScrollView+HorizonView","JS与Android交互","文件选择器","分享多图到朋友圈",
            "上升气泡效果","MVP+RxAndroid+Retrofit","Https请求","子线程间通信","5.0新控件","自定义控件",
            "X5 WebView(待优化)","自定义相机","百分比布局","图片堆叠效果"};
