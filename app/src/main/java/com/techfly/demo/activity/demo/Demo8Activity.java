...
public class Demo8Activity extends BaseActivity {
    ...
    private int SPLASH_TYPE = 0;//1-本地图片；2-网络图片; 3-GIF
    private int count = 0;
            ...
            switch (msg.what) {
                ...
                case GO_UPDATE:
                    ...
                    if(m_gif_duration / 1000 >= 0){
                        splash_jump_tv.setText("切换\t"+m_gif_duration / 1000+"s");
                    }
    ...
    private void goHome() {
//        Intent intent = new Intent(Demo8Activity.this, LoginActivity.class);
//        startActivity(intent);
//        this.finish();
    }

    private void goGuide() {
//        Intent intent = new Intent(Demo8Activity.this, GuideActivity.class);
//        Demo8Activity.this.startActivity(intent);
//        this.finish();
    }
    ...
    public void jumpToLogin() {
        ...
        splash_show_iv.refreshDrawableState();

        LogsUtil.normal("SPLASH_TYPE="+SPLASH_TYPE+",count="+count);
