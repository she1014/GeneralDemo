...
/**
 * BaseActivity-FragmentActivity2-无侧滑结束当前Activity效果
 */
public class BaseFragmentActivity2 extends FragmentActivity implements GetResultCallBack {
    ...
    public void setTranslucentStatus(int color) {
        ...
        int getSystemType = StatusBarUtil.StatusBarLightMode(BaseFragmentActivity2.this);
        StatusBarUtil.StatusBarLightMode(BaseFragmentActivity2.this, getSystemType);
    }
    ...
    private void isNetConnect() {
        if (NetWorkUtil.isNetWorkConnected(BaseFragmentActivity2.this)) {
        } else if (BaseFragmentActivity2.this != null) {
            ToastUtil.DisplayToast(BaseFragmentActivity2.this, Constant.TOAST_MEG_NETWORK_NULL);
        }
    }
